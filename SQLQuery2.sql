USE [Больница]
GO
ALTER TABLE [dbo].[Прием] DROP CONSTRAINT [FK_Прием_Стоимость]
GO
ALTER TABLE [dbo].[Прием] DROP CONSTRAINT [FK_Прием_Пациент]
GO
ALTER TABLE [dbo].[Прием] DROP CONSTRAINT [FK_Прием_Диагноз]
GO
ALTER TABLE [dbo].[Прием] DROP CONSTRAINT [FK_Прием_Врачь]
GO
/****** Object:  Table [dbo].[Стоимость]    Script Date: 31.01.2024 11:14:49 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Стоимость]') AND type in (N'U'))
DROP TABLE [dbo].[Стоимость]
GO
/****** Object:  Table [dbo].[Прием]    Script Date: 31.01.2024 11:14:49 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Прием]') AND type in (N'U'))
DROP TABLE [dbo].[Прием]
GO
/****** Object:  Table [dbo].[Пациент]    Script Date: 31.01.2024 11:14:49 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Пациент]') AND type in (N'U'))
DROP TABLE [dbo].[Пациент]
GO
/****** Object:  Table [dbo].[Диагноз]    Script Date: 31.01.2024 11:14:49 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Диагноз]') AND type in (N'U'))
DROP TABLE [dbo].[Диагноз]
GO
/****** Object:  Table [dbo].[Врачь]    Script Date: 31.01.2024 11:14:49 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Врачь]') AND type in (N'U'))
DROP TABLE [dbo].[Врачь]
GO
/****** Object:  Table [dbo].[Авторизация]    Script Date: 31.01.2024 11:14:49 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Авторизация]') AND type in (N'U'))
DROP TABLE [dbo].[Авторизация]
GO
USE [master]
GO
/****** Object:  Database [Больница]    Script Date: 31.01.2024 11:14:49 ******/
DROP DATABASE [Больница]
GO
/****** Object:  Database [Больница]    Script Date: 31.01.2024 11:14:49 ******/
...
GO
INSERT [dbo].[Пациент] ([НомерКарты], [ФИО], [ДатаРождения], [Пол], [Талон]) VALUES (1111, N'Петрова Анна Петровна', CAST(N'1990-05-15' AS Date), 0, 12345)
GO
SET IDENTITY_INSERT [dbo].[Прием] ON 
GO
INSERT [dbo].[Прием] ([Код], [КодВрача], [КодПациента], [ДатаВизита], [КодСтоимости], [Цель], [КодДиагноза]) VALUES (6, 1, 1111, N'12122005', 1, N'1', 1)
GO
INSERT [dbo].[Прием] ([Код], [КодВрача], [КодПациента], [ДатаВизита], [КодСтоимости], [Цель], [КодДиагноза]) VALUES (8, 1, 1111, N'12102005', 1, N'Просто так', 1)
GO
