USE [master]
GO
/****** Object:  Database [Больница]    Script Date: 19.01.2024 10:11:27 ******/
...
USE [Больница]
GO
/****** Object:  Table [dbo].[Авторизация]    Script Date: 19.01.2024 10:11:27 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Врачь]    Script Date: 19.01.2024 10:11:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Диагноз]    Script Date: 19.01.2024 10:11:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Пациент]    Script Date: 19.01.2024 10:11:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Прием]    Script Date: 19.01.2024 10:11:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Стоимость]    Script Date: 19.01.2024 10:11:27 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT INTO [dbo].[Прием] ([Код], [КодВрача], [КодПациента], [ДатаВизита], [КодСтоимости], [Цель], [КодДиагноза])
VALUES (1, 1, 1111, '2024-01-19', 1, N'Прием у терапевта', 1)